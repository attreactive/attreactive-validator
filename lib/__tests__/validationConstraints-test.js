...
describe('objectValidity', function() {
  it('should validate', function() {
    var validator = validationConstraints.objectValidity({
      value: {
    ...
    expect(validator('')).toBeFalsy();
    expect(validator([])).toBeFalsy();
    expect(validator({value: false})).toBeFalsy();

    expect(validator({value: true})).toBeTruthy();
  });
});

describe('arrayValidity', function() {
  it('should validate', function() {
    var validator = validationConstraints.arrayValidity({
      value: {
        isTrue: validationConstraints.isTrue()
      }
    });
    ...
    expect(validator('')).toBeFalsy();
    expect(validator([{value: false}])).toBeFalsy();
    expect(validator([{value: false}, {value: true}])).toBeFalsy();

    expect(validator([{value: true}, {value: true}])).toBeTruthy();
  });
});
